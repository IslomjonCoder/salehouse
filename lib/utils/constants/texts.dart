/// This class contains all the App Texts in String format.
class TTexts {
  TTexts._();
 // -- Login Texts --
  ...
  static const String nickValidate = 'Loginni kiriting';
  ...
  static const String loginError = 'Ismingiz yoki parol noto\'g\'ri';
